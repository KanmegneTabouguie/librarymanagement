...
// Publish a book
router.post('/publish/:id', getBook, async (req, res) => {
    console.log('Request Body:', req.body);
    console.log('Content-Type:', req.get('Content-Type'));
    console.log('Book ID:', req.params.id);
    console.log('Book Object:', res.book); // Log the book object

    // Reuse the logic from the PUT request to update the book
    if (req.body.available !== undefined) {
        res.book.available = req.body.available;
    } else {
        res.book.available = true; // Default to true if not provided in the request
    }
